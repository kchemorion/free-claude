...
const claude_1 = __webpack_require__(2);
const codeGenerator_1 = __webpack_require__(43);
const gitIntegration_1 = __webpack_require__(44);
const documentationGenerator_1 = __webpack_require__(46);
...
const vscode = __importStar(__webpack_require__(1));
const child_process = __importStar(__webpack_require__(45));
...
5. Dependencies and requirements`;
    ...
    getDocumentationUri(sourceUri) {
        const path = sourceUri.path;
        return sourceUri.with({
            path: path.replace(/\.[^.]+$/, '.md')
        });
    }
    getAPIDocumentationUri(sourceUri) {
        const path = sourceUri.path;
        return sourceUri.with({
